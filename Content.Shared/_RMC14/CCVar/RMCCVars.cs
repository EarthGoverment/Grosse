...
public sealed class RMCCVars : CVars
{
    ...
    public static readonly CVarDef<string> RMCPlanetMaps =
        CVarDef.Create("rmc.planet_maps", "/Maps/_TGMC/researchoutpost.yml,/Maps/_RMC14/solaris.yml,/Maps/_RMC14/prison.yml,/Maps/_RMC14/shiva.yml", CVar.SERVER | CVar.SERVERONLY);
